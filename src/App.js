    ...
    <div className="App">
      ...
      <main>
        ...
        <Section className='add-bottom'>
          <SectionHeader title='Почему у нас хорошо'/>
          <div className='cards-grid features'>
            ...
            <div className='cards-row'>
              <div className='card feature-3'>2&nbsp;крепких проекта в&nbsp;вашем портфолио: сайт и&nbsp;мобильное приложение</div>
            </div>
        ...
        <Section className='process-section'>
          <SectionHeader
            title='Мастер-классы и&nbsp;разбор теории'
