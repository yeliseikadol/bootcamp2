      ...
      <main>
        ...
        <Section className='add-bottom'>
          ...
          <div className='cards-grid features'>
            ...
            <div className='cards-row'> 
              ...
              <div className='card feature-7'>А ещё вы научитесь компьютерной вёрстке. Это значит, что вы сами сможете помочь кому-то запустить или обновить бизнес.</div>
        ...
        <Section className='process-section add-top'>
          <SectionHeader
            ...
            text1='Время с преподавателем уйдёт на практику, а теорию вы будете изучать дома. У вас будет единый файл с остальными студентами, и вы будете видеть их прогресс, разницу мнений и ошибки. А ещё это удобно, потому что учитель сразу даёт фидбек.'
            />
        ...
        <Section className='process-section'>
          <SectionHeader
            ...
            text1='У вас будут отличные учебники Бюро Горбунова по проектированию страниц, дизайну интерфейсов, редактуре и личной эффективности. В них есть примеры и тесты.'
            />
        ...
        <Section className='process-section'>
          <SectionHeader
            ...
            text1='Каждую неделю у вас будет задание, которое надо сдать до конца пятницы. Задание можно обсуждать в чатах с другими студентами, а по четвергам лично с преподавателем.'
            />
        ...
        <Section className='process-section'>
          <SectionHeader
            ...
            text1='Каждую неделю преподаватель проводит мастер-класс для желающих. Например, как сделать анимацию, как собрать сайт в конструкторе или ещё что-то клёвое. Кстати, у вас будет доступ ко всем будущим мастер-классам.'
            />
